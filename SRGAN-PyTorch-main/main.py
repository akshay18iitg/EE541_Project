...
parser.add_argument("--LR_path", type = str, default = './data/DIV2K_train_HR')
parser.add_argument("--GT_path", type = str, default = './data/DIV2K_train_LR_mild')
parser.add_argument("--LR_path_val", type = str, default = './data/DIV2K_valid_HR')
parser.add_argument("--GT_path_val", type = str, default = './data/DIV2K_valid_LR_mild')
...
parser.add_argument("--fine_train_epoch", type = int, default = 500)
